                ...
                <el-form :inline="true" :model="filters" :size="normalSize">
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="marketing:advert_position:view" slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add" perms="marketing:advert_position:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
                    ...
                    <el-col :span="16">
                        ...
                        <el-form-item label="模板编码" prop="code">
                            <el-select placeholder="请选择" v-model="formData.code">
                                <el-option :key="item.key" :label="item.value" :value="item.key" v-for="item in advertTemplates"></el-option>
                            </el-select>
                        </el-form-item>
