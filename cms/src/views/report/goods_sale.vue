<template>
    <div class="page-container">
            ...
            <el-col :span="14" class="top-bar">
                <el-form :inline="true" :size="miniSize">
                    <el-form-item>
                        ...
                        <ext-button :label="$t('action.search')" @click="getGoodsList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="report:goods_collection:view" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <!--表格内容栏-->
        <ext-table :columns="columns" :data="collectionList" :isPaging="false" :showOperation="false" @queryForPaginatedList="getGoodsList"></ext-table>
    </div>
</template>
