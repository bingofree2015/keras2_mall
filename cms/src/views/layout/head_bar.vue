<template>
    <div :class="collapse?'position-collapse-left':'position-left'" :style="{'background':themeColor}" class="headbar">
        <!-- 导航收缩 -->
        <span class="hamburg">
            <el-menu :background-color="themeColor" active-text-color="#ffd04b" class="el-menu-demo" mode="horizontal" text-color="#fff">
        ...
        <span class="toolbar">
            <el-menu :background-color="themeColor" active-text-color="#ffd04b" class="el-menu-demo" mode="horizontal" text-color="#fff">
                <el-menu-item index="1">
                    <!-- 主题切换 -->
                    <theme-picker :default="themeColor" @onThemeChange="onThemeChange" class="theme-picker"></theme-picker>
                </el-menu-item>
