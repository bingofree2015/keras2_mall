        ...
        <el-row :gutter="10" justify="space-between">
            ...
            <el-col :span="8">
                <el-card class="box-card">
                    ...
                    <div class="body">
                        <el-timeline>
                            <el-timeline-item :color="activity.color" :icon="activity.icon" :key="index" :size="activity.size" :timestamp="activity.timestamp" :type="activity.type" v-for="(activity, index) in activities">{{activity.content}}</el-timeline-item>
                        </el-timeline>
                    </div>
                </el-card>
            </el-col>
...
.page-container ::v-deep .box-card {
    .el-card__header {
        text-align: left;
        height: 42px;
        padding: 10px;
