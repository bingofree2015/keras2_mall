<template>
	<div class="page-container">
				...
				<el-form :inline="true" :model="filters" :size="normalSize">
					<el-form-item>
						<el-input placeholder="请输入内容" v-model="filters.value">
							...
							<ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="pay:view" slot="append" type="primary" />
						</el-input>
					</el-form-item>
					<el-form-item>
						<el-button-group>
		...
		<!--表格内容栏-->
		<ext-table :columns="columns" :count="paginated.attrs.count" :data="paginated.list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated.attrs.limit" @queryForPaginatedList="queryForPaginatedList" aliasName="payment"></ext-table>

		<!--新增编辑界面-->
		<el-dialog :close-on-click-modal="false" :visible.sync="editDialogVisible" class="edit-dialog" title="编辑" width="50%">
			<el-form :model="formData" :size="normalSize" label-width="100px" ref="formData">
				...
				<template v-else-if="formData.code === 'alipay'">
					...
					<el-form-item label="RSA私钥:" prop="params.rsaPrivateKey">
						<el-input :rows="2" placeholder="请输入rsaPrivateKey" type="textarea" v-model="formData.params.rsaPrivateKey"></el-input>
					</el-form-item>
					<el-form-item label="支付宝公钥:" prop="params.alipayPublicKey">
						<el-input :rows="2" placeholder="请输入支付宝公钥" type="textarea" v-model="formData.params.alipayPublicKey"></el-input>
					</el-form-item>
				</template>
				<el-row>
					<el-col :span="9">
						<el-form-item label="排序:" prop="sort">
							<el-input-number :max="10" :min="1" controls-position="right" v-model="formData.sort"></el-input-number>
						</el-form-item>
					</el-col>
					<el-col :span="9">
