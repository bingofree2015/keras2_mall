<template>
	<div class="page-container">
				...
				<el-form :inline="true" :model="filters" :size="normalSize">
					<el-form-item>
						<el-input placeholder="请输入内容" v-model="filters.value">
							...
							<ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="pay:bill_payment:view" slot="append" type="primary" />
						</el-input>
					</el-form-item>
					<el-form-item>
						<el-button-group>
		...
		<!--表格内容栏-->
		<ext-table :columns="columns" :count="paginated.attrs.count" :data="paginated.list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated.attrs.limit" @queryForPaginatedList="queryForPaginatedList" aliasName="bill_payment"></ext-table>
		...
		<el-dialog :close-on-click-modal="false" :visible.sync="viewDialogVisible" title="编辑" width="40%">
			<el-form :model="formData" :size="miniSize" class="dialog-container" label-width="80px" ref="formData">
				...
				<el-row>
					<el-col :span="12">
						<el-form-item label="类型:" prop="type">{{env.columnFormatter(formData.type,'bill_payment','type')}}</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="状态:" prop="state">{{env.columnFormatter(formData.state,'bill_payment','state')}}</el-form-item>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="12">
				...
				<el-row>
					<el-col :span="24">
						<el-table :data="formData.billPaymentItems" :size="miniSize" stripe style="width: 100%">
							<el-table-column label="单号" min-width="360" prop="sourceId" show-overflow-tooltip></el-table-column>
