				...
				<el-table :data="mediaMessageItems" :size="miniSize" stripe style="width: 100%">
					<el-table-column minWidth="180" prop="title">
						<template slot="header">
							图文列表
							<el-button @click="handleCreate()" round size="mini" style="float:right;" type="primary">新增</el-button>
						</template>
						<template slot-scope="scope">
							<span style="margin-left:10px">
								<el-link :underline="false" @click="handleEdit(scope.$index)">{{ scope.row.title }}</el-link>
								<el-button @click="handleDelete(scope.$index)" circle icon="el-icon-delete" size="mini" style="float:right;" type="danger"></el-button>
							</span>
						</template>
					</el-table-column>
				</el-table>
					...
					<el-main>
						...
						<el-form :model="formData" :rules="formDataRules" :size="normalSize" label-width="80px" ref="formData">
							...
							<el-form-item label="摘要" prop="brief">
								<el-input :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入内容" type="textarea" v-model="formData.brief"></el-input>
							</el-form-item>
							<el-form-item label="详细内容" prop="content">
								<tinyEditor :content.sync="formData.content"></tinyEditor>
							</el-form-item>
