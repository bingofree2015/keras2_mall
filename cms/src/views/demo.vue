<template>
    <el-container>
        ...
        <el-main>
                    ...
                    <el-card>
                        <div slot="header">
                            <pick-goods :selectionType="1"
                                @chosedGoods="chosedGoods"></pick-goods>
                        </div>
                        {{goods.map(v=>v.name)}}
                    </el-card>
                </el-col>
                    ...
                    <el-card>
                        <div slot="header">
                            <pick-article :selectionType="0"
                                @chosedArticles="chosedArticles"></pick-article>
                        </div>
                    ...
                    <el-card>
                        <div slot="header">
                            <el-input class="input-with-select"
                                placeholder="请输入内容" v-model="input3">
                    ...
                    <el-card>
                        <div slot="header">
                            <pick-form :selectionType="0"
                                @chosedForms="chosedForms"></pick-form>
                        </div>
                        {{forms.map(v=>v.name)}}
                    </el-card>
                </el-col>
            ...
            <el-row>
                <el-col :span="6">
                    <el-card>
                        <div slot="header">
                            <pick-area :selectionType="0"
                                @chosedAreas="chosedAreas"></pick-area>
                        </div>
                        {{areas.map(v=>v.name)}}
                    </el-card>
                </el-col>
            ...
            <el-row>
                <el-col :span="6">
                    <el-button :size="miniSize" @click="handleClick" round
            ...
            <el-row>
                <el-col :span="16">
                    <draggable-image-list :items="imageItems"
                        @chosedImage="chosedImage" @end="end"
                        @onRemove="onRemove"></draggable-image-list>
                </el-col>
                <el-col :span="8">
                    <el-upload :auto-upload="false" :on-change="changeUpload"
                        :show-file-list="false" action drag>
            ...
            <el-row>
                <el-col :span="6">
                    <el-cascader :options="cascaderOpts"
                        :show-all-levels="false" v-model="cascaderValue">
                    </el-cascader>
                </el-col>
            ...
            <el-row>
                <el-col :span="24">
                    <div class="sf-image-grid-container">
                        <div :style="{ margin: -padding + 'px' }"
                            class="sf-image-grid-list">
                            <div :style="{ padding: padding + 'px' }"
                                class="sf-image-item">bingofree1</div>
        ...
        <!-- vueCropper 剪裁图片实现-->
        <el-dialog :visible.sync="cropDialogVisible" append-to-body
            title="图片剪裁">
            <el-form :inline="true" :size="miniSize">
                <el-container>
                    <el-main class="cropper-container">
                        <vueCropper :autoCrop="option.autoCrop"
                            :canMove="option.canMove"
                            :canMoveBox="option.canMoveBox"
                            :centerBox="option.centerBox" :fixed="option.fixed"
                            :fixedBox="option.fixedBox"
                            :fixedNumber="option.fixedNumber"
                            :full="option.full" :img="option.img" :info="true"
                            :infoTrue="option.infoTrue"
                            :original="option.original"
                            :outputSize="option.size"
                            :outputType="option.outputType" ref="cropper">
                        </vueCropper>
                    </el-main>
                    <el-footer>
                        <el-form-item>
                            <el-button-group>
                                <el-button @click="changeScale(1)"
                                    icon="el-icon-ali-fangda" round
                                    type="primary"></el-button>
                                <el-button @click="changeScale(-1)"
                                    icon="el-icon-ali-suoxiao" round
                                    type="primary"></el-button>
                                <el-button @click="rotateLeft"
                                    icon="el-icon-ali-left" round
                                    type="primary"></el-button>
                                <el-button @click="rotateRight"
                                    icon="el-icon-ali-right" round
                                    type="primary"></el-button>
                            </el-button-group>
                        </el-form-item>
                    </el-footer>
            ...
            <div class="dialog-footer" slot="footer">
                <el-button :size="normalSize" @click="cropDialogVisible = false"
                    round>取 消</el-button>
                <el-button :loading="loading" :size="normalSize"
                    @click="uploadCropData" round type="primary">确认</el-button>
            </div>
        </el-dialog>
