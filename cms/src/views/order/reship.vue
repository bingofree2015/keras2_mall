<template>
    <div class="page-container">
                ...
                <el-form :inline="true" :model="filters" :size="normalSize">
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="order:reship:view" slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <!--表格内容栏-->
        <ext-table :columns="columns" :count="paginated.attrs.count" :data="paginated.list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated.attrs.limit" @queryForPaginatedList="queryForPaginatedList"></ext-table>
        ...
        <el-dialog :close-on-click-modal="false" :visible.sync="viewDialogVisible" title="退货单查看" width="40%">
            <el-form :model="formData" :size="miniSize" label-width="80px" ref="formData" class="dialog-container">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="快递公司:" prop="logistics">{{formData.logistics ? formData.logistics.logiName:''}}</el-form-item>
                    </el-col>
                    <el-col :span="12">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-table :data="formData.billReshipItems" :size="miniSize" stripe style="width: 100%">
                            <el-table-column label="货品名称" min-width="360" prop="name" show-overflow-tooltip></el-table-column>
