                ...
                <el-form :inline="true" :model="filters" :size="normalSize">
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="system:dict:view" slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add" perms="system:dict:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <el-dialog :close-on-click-modal="false" :title="isCreating?'新增':'编辑'" :visible.sync="editDialogVisible" width="40%">
            <el-form :model="formData" :rules="formDataRules" :size="normalSize" label-width="80px" ref="formData">
                ...
                <el-form-item label="排序" prop="sort">
                    <el-input-number :min="0" controls-position="right" label="排序" style="max-width:100px" v-model="formData.sort"></el-input-number>
                </el-form-item>
