<template>
	<div>
		<ext-button :size="miniSize" @click="handlePickArea()" icon="el-icon-ali-Newxuanzeshangpinxuanzhong" label="选择区域" type="primary" />
		<el-dialog :close-on-click-modal="false" :modal-append-to-body="false" :size="miniSize" :visible.sync="dialogVisible" title="区域选择窗" width="40%">
			<el-tree :default-checked-keys="areaIds" :load="loadNode" :props="props" lazy node-key="id" ref="areaTree" show-checkbox></el-tree>
