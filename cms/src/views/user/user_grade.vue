				...
				<el-form :inline="true" :model="filters" :size="normalSize">
					<el-form-item>
						<el-input placeholder="请输入内容" v-model="filters.value">
							...
							<ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="user:user_grade:view" slot="append" type="primary" />
						</el-input>
					</el-form-item>
					<el-form-item>
						<ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add" perms="user:user_grade:add" type="primary" />
					</el-form-item>
					<el-form-item>
						<el-button-group>
				...
				<el-row>
					<el-col :span="16">
						<el-form-item label="编号" prop="level">
							<el-input-number :min="0" controls-position="right" label="编号" style="width:100px" v-model="formData.level"></el-input-number>
						</el-form-item>
