<template>
    <div>
        <ext-button :size="miniSize" @click="handlePickGoods()" icon="el-icon-ali-Newxuanzeshangpinxuanzhong" label="选择商品" type="primary" />
        <el-dialog :modal-append-to-body="false" :close-on-click-modal="false" :size="miniSize" :visible.sync="dialogVisible" title="商品选择窗" width="50%">
            <el-table :data="paginated.list" :size="miniSize" @selection-change="multipleChoiceChange" element-loading-text="$t('action.loading')" stripe v-loading="loading">
                <el-table-column align="center" minWidth="40" type="selection" v-if="selectionType==1"></el-table-column>
