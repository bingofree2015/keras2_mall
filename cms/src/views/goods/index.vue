	...
	<div class="page-container">
				...
				<el-form :inline="true" :model="filters" :size="normalSize">
					<el-form-item>
						<el-input placeholder="请输入内容" v-model="filters.value">
							...
							<ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="goods:view" slot="append" type="primary" />
						</el-input>
					</el-form-item>
					<el-form-item>
						<ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add" perms="goods:add" type="primary" />
					</el-form-item>
					<el-form-item>
						<el-button-group>
		...
		<el-tabs @tab-click="handleClick" class="tab-container" type="border-card" v-model="activeName">
			<el-tab-pane name="all">
				...
				<!--表格内容栏-->
				<ext-table :batchDelete="batchDelete" :columns="columns" :count="paginated['all'].attrs.count" :data="paginated['all'].list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated['all'].attrs.limit" :permsBatchDelete="permsBatchDelete" @queryForPaginatedList="queryForPaginatedList" tabName="all"></ext-table>
			</el-tab-pane>
			<el-tab-pane name="up">
				<span slot="label">
				...
				<!--表格内容栏-->
				<ext-table :batchDelete="batchDelete" :columns="columns" :count="paginated['up'].attrs.count" :data="paginated['up'].list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated['up'].attrs.limit" :permsBatchDelete="permsBatchDelete" @queryForPaginatedList="queryForPaginatedList" tabName="up"></ext-table>
			</el-tab-pane>
			<el-tab-pane name="down">
				...
				<!--表格内容栏-->
				<ext-table :batchDelete="batchDelete" :columns="columns" :count="paginated['down'].attrs.count" :data="paginated['down'].list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated['down'].attrs.limit" :permsBatchDelete="permsBatchDelete" @queryForPaginatedList="queryForPaginatedList" tabName="down"></ext-table>
			</el-tab-pane>
			<el-tab-pane name="warn">
				...
				<!--表格内容栏-->
				<ext-table :batchDelete="batchDelete" :columns="columns" :count="paginated['warn'].attrs.count" :data="paginated['warn'].list" :operations="operations" :operationWidth="operationWidth" :pageSize="paginated['warn'].attrs.limit" :permsBatchDelete="permsBatchDelete" @queryForPaginatedList="queryForPaginatedList" tabName="warn"></ext-table>
			</el-tab-pane>
		</el-tabs>
	</div>
</template>
