                ...
                <el-form :inline="true" :model="filters" :size="normalSize">
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="goods:goods_spec:view" slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add" perms="goods:goods_spec:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <el-dialog :close-on-click-modal="false" :title="isCreating?'新增':'编辑'" :visible.sync="editDialogVisible" width="40%">
            <el-form :model="formData" :rules="formDataRules" :size="normalSize" label-width="80px" ref="formData">
                ...
                <el-form-item label="排序" prop="sort">
                    ...
                    <el-button @click.prevent="addSpecValue()" round style="float:right" type="primary">添加属性值</el-button>
                </el-form-item>
                <el-form-item :key="index" :label="'属性' + index" :prop="'goodsSpecValues.' + index + '.value'" :rules="{required: true, message: '属性值不能为空', trigger: 'blur'}" v-for="(specValue, index) in formData.goodsSpecValues">
                    <el-row>
                        <el-col :span="16">
                            <el-input v-model="specValue.value"></el-input>
                        </el-col>
                        <el-col :span="8">
                            <el-button @click.prevent="removeSpecValue(specValue)" circle icon="el-icon-delete" type="danger"></el-button>
                        </el-col>
                    </el-row>
                </el-form-item>
            </el-form>
