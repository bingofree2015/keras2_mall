<template>
    <div class="page-container">
        ...
        <!--表格内容栏-->
        <ext-table :columns="columns" :count="paginated.attrs.count" :data="paginated.list" :pageSize="paginated.attrs.limit" :showOperation="false" @queryForPaginatedList="queryForPaginatedList"></ext-table>
    </div>
</template>
