<template>
    <div class="page-container">
        ...
        <el-row>
            ...
            <el-col :span="14" class="top-bar">
                <el-form :inline="true" :size="miniSize">
                    <el-form-item>
                        <el-date-picker :picker-options="pickerOptions" align="right" end-placeholder="结束日期" range-separator="至" start-placeholder="开始日期" style="width:240px;" type="daterange" unlink-panels v-model="rangeDate"></el-date-picker>
                        <ext-button :label="$t('action.search')" @click="getCollectionList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="report:goods_collection:view" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <!--表格内容栏-->
        <ext-table :columns="columns" :data="collectionList" :isPaging="false" :showOperation="false" @queryForPaginatedList="getCollectionList"></ext-table>
    </div>
</template>
