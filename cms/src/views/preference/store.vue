                ...
                <el-form :inline="true" :model="filters" :size="normalSize">
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="preference:store:view" slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.add')" @click="handleAdd" icon="el-icon-ali-add" perms="preference:store:add" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
                ...
                <el-row>
                    <el-col :span="10">
                        <el-form-item label="地区" prop="areaId">
                            <el-cascader :options="areaList" :props="cascaderProps" :show-all-levels="false" v-model="formData.areaId"></el-cascader>
                        </el-form-item>
                    </el-col>
                    <el-col :span="14" class="top-bar">
