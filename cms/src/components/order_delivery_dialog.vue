<template>
	<el-dialog :close-on-click-modal="false" :modal="false" @open="openDialog" title="订单发货" v-bind="$attrs" v-on="$listeners" width="60%">
				...
				<el-col :span="12">
					<el-form-item label="物流公司" prop="logisticsId">
						<el-select placeholder="请选择" v-model="formData.logisticsId">
							<el-option :key="logi.id" :label="logi.logiName" :value="logi.id" v-for="logi in logistics"></el-option>
						</el-select>
					</el-form-item>
				</el-col>
				<el-col :span="12">
