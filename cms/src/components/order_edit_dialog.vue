<template>
	<el-dialog :close-on-click-modal="false" :modal="false" @open="openDialog" title="订单编辑" v-bind="$attrs" v-on="$listeners" width="50%">
				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="收货区域" prop="shipAreaId">
							<el-cascader :options="areas" :props="cascaderProps" :show-all-levels="false" v-model="formData.shipAreaId"></el-cascader>
						</el-form-item>
					</el-col>
				</el-row>
				<el-row>
