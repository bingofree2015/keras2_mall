    ...
    <div class="page-container">
                ...
                <el-form :inline="true" :model="filters" :size="normalSize">
                    <el-form-item>
                        <el-input placeholder="请输入内容" v-model="filters.value">
                            ...
                            <ext-button :label="$t('action.search')" @click="queryForPaginatedList()" icon="el-icon-ali-chazhaobiaodanliebiao" perms="order:view" slot="append" type="primary" />
                        </el-input>
                    </el-form-item>
                    <el-form-item>
                        <ext-button :label="$t('action.batchPay')" @click="handleBatchPay" icon="el-icon-ali-piliangzhifu" perms="order:pay" type="primary" />
                    </el-form-item>
                    <el-form-item>
                        <el-button-group>
        ...
        <el-tabs @tab-click="handleClick" class="tab-container" type="border-card" v-model="activeName">
            <el-tab-pane name="all">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['all'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['all'].list" :pageSize="paginated['all'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="all"></order-table>
            </el-tab-pane>
            <el-tab-pane name="payment">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['payment'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['payment'].list" :pageSize="paginated['payment'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="payment"></order-table>
            </el-tab-pane>
            <el-tab-pane name="delivered">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['delivered'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['delivered'].list" :pageSize="paginated['delivered'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="delivered"></order-table>
            </el-tab-pane>
            <el-tab-pane name="receive">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['receive'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['receive'].list" :pageSize="paginated['receive'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="receive"></order-table>
            </el-tab-pane>
            <el-tab-pane name="evaluated">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['evaluated'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['evaluated'].list" :pageSize="paginated['evaluated'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="evaluated"></order-table>
            </el-tab-pane>
            <el-tab-pane name="cancel">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['cancel'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['cancel'].list" :pageSize="paginated['cancel'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="cancel"></order-table>
            </el-tab-pane>
            <el-tab-pane name="complete">
                ...
                <!--表格内容栏-->
                <order-table :batchDelete="batchDelete" :count="paginated['complete'].attrs.count" :operationWidth="operationWidth" :orderData="paginated['complete'].list" :pageSize="paginated['complete'].attrs.limit" :permsBatchDelete="permsBatchDelete" @handleAction="handleAction" @handlePrint="handlePrint" @queryForPaginatedList="queryForPaginatedList" type="complete"></order-table>
            </el-tab-pane>
        </el-tabs>
